...
import { MapPin, Star, Clock, Users, ArrowRight, Heart, Calendar, DollarSign } from 'lucide-react';
          ...
          {destinations.map((destination, index) => (
            ...
            >
              <div className="relative overflow-hidden">
                ...
                {/* Price */}
                <div className="absolute top-4 right-4 bg-gradient-to-r from-sky-500 to-blue-600 text-white px-3 py-1 rounded-full text-sm font-bold shadow-lg">
                  {destination.price}
                </div>

                {/* Heart icon - Only show on larger screens */}
                <motion.button
                ...
                >
                  <motion.button
                    ...
                    className="bg-white/90 backdrop-blur-sm hover:bg-white text-gray-900 px-4 py-2 rounded-full text-sm font-semibold flex items-center gap-2 shadow-lg"
                  >
                    View Details
                ...
                <div className="flex gap-2">
                  <motion.button
                    whileHover={{ 
                      ...
                      boxShadow: window.innerWidth > 768 ? '0 10px 30px rgba(14, 165, 233, 0.3)' : 'none'
                    }}
                    whileTap={{ scale: 0.98 }}
                    onClick={() => handleBookNow(destination.name)}
                    className="flex-1 bg-gradient-to-r from-sky-500 to-orange-500 hover:from-sky-600 hover:to-orange-600 text-white py-3 rounded-xl font-semibold transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-2 group/btn"
                  >
        ...
        >
          <motion.button
            whileHover={{ 
              ...
              boxShadow: window.innerWidth > 768 ? '0 15px 35px rgba(0, 0, 0, 0.1)' : 'none'
            }}
            whileTap={{ scale: 0.95 }}
            ...
            className="bg-white dark:bg-gray-800 text-gray-900 dark:text-white px-8 py-4 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-gray-700 flex items-center gap-2 mx-auto"
          >
